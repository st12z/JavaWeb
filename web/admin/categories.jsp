...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="container">
                <div class="mb-4">
                    <a href="/Shop/admin/create-category">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table-cart ">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listCategories}" var="item" varStatus="status">
                                        <tr>
                                            <td>${status.index+1}</td>
                                            <td>${item.name}</td>
                                            <td>${item.description}</td>
                                            <td>
                                                <a href="/Shop/admin/edit-category/${item.id}">
                                                    <i class="fa-solid fa-pen-to-square" width="150px"></i>
                                                </a>
                                                <a href="/Shop/admin/delete-category/${item.id}">
