            ...
            <div class="container">
                <form method="POST" action="/Shop/admin/create-product" form-product enctype="multipart/form-data">
                    ...
                    <div class="form-group" upload-image >
                        <label class="form-label" class="small mb-1" for="image">Ảnh</label>
                        <input upload-image-input  class="form-control-file" type="file" id="image" name="image" accept="images/*" required/>
