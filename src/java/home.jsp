    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item ">
                    <a class="nav-link ${cid==null?"active":""}" href="home">ALL</a>
                </li>
                <c:forEach items="${requestScope.categories}" var="c">
                    <li class="nav-item ">
                        <a class="nav-link ${cid==c.id?"active":""}"  href="home?cid=${c.id}">${c.name}</a>
                    </li>
                </c:forEach>
                        ...
                        <c:if test="${requestScope.currentPage>1}">
                            <li class="page-item">
                                <button class="page-link" 
                                        button-pagination data-cid="${cid}" data-page="${requestScope.currentPage-1}"  data-keyword="${keyword}"  >Previous</button>
                            </li>
                        </c:if>
